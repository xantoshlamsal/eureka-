...
class Blueprint
{
    ...
    public function tableMandatoryFields($precision = 0)
    {
        $this->timestamp('TranDate');
        $this->foreignId('TranUserId')->constrained('users');
        $this->tinyInteger('Status');
        $this->foreignId('StatusChangeUserId')->constrained('users');
        $this->timestamp('StatusChangeDate');
    }
